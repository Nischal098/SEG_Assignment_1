...
public class Design6RuntimeTest3{
	
	public static Design6PointCP3 pointDesign3;
	...
	public static long Runtime(int methodNumber) {
		...
		for(int i = 0; i < 10000000; i++) {
			switch (methodNumber){
				...
				case 6:
					pointDesign3.getDistance(new Design6PointCP3('C',rand.nextInt(1000),rand.nextInt(1000)));
				case 7:
